...
![](VAPoster_files/02.png){width=50%}
...
![](VAPoster_files/10.png){width=60%}
...
![](VAPoster_files/08.png){width=70%}
...
![](VAPoster_files/09.png){width=80%}
...
![](VAPoster_files/12.png){width=100%}
*Fig 7. Blog term frequency by hours*

![](VAPoster_files/13.png)
