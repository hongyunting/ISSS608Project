...
Furthermore, by and large, most of the team submissions do not provide detailed information for the focused employees hence the investigators may need to manually collect these information as well. 
...
The histogram plot on the right side displays the distribution of the transactions at each location. The plot is able to show the hot spots at different time period and when they are popular. A diverging colour scheme 'spectral' is applied to clearly differentiate different time periods.
...
- TODO: placeholder for Text analytics page design 
...
![](VAPaper_IMG/03.png)
*Fig 7. Number of transactions at each work-related location at different time*
...
![](VAPaper_IMG/08.png)
*Fig 8. Executives Golf sessions on 12th Jan*
...
![](VAPaper_IMG/09.png)
*Fig 9. Traces of Elsa Orilla and Brand Tempestad on 10th Jan*

However, based on the transaction details from below, they paid their bills separately.

![](VAPaper_IMG/10.png)
*Fig 10. transactionns of Elsa Orilla and Brand Tempestad on 10th Jan at Chostus Hotel*
...
The geo-spatial analysis could be further enhanced with the use of [moveVis](http://movevis.org/) package to dynamically visualize movement data by creating video animations. This aims the visual interpretations of the movement patterns with traces following the timestamps in sequences.
